...
/*   Updated: 2025/04/22 14:59:06 by ndziadzi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const &form) {
	try {
		...
		std::cerr << getName() << " couldn't execute " << std::flush;
		std::cerr << form.getName() << ", because " << std::flush;
		std::cerr << "form grade is: " << form.getReqToExec() << std::flush;
		std::cerr << " and Bureaucrat grade is: " << getGrade() << std::endl;
	}
}
